...
import {
    ...
    Image,
    StatusBar,
    SafeAreaView, KeyboardAvoidingView, Platform, TextInput, Modal, Alert,
} from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import type { NativeStackScreenProps } from '@react-navigation/native-stack';
import type { RootStackParamList } from '@/navigation/types';
import AsyncStorage from "@react-native-async-storage/async-storage";
import {gameStakeAmount, getDemoQuestion, getUserDetails, loginUser} from "@/services/authService";
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.categoriesGrid}>
                    {userDetails?.category.slice(0, 4).map((category) => (
                        <TouchableOpacity key={category.id} style={styles.categoryCard} onPress={() => handlePlayPress(category)}>
